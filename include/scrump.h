 ...
 * read/write "cursor" pattern. This is a single header library, so if you would like to use it simply
 * copy/paste scrump.h into your project (most likely your include/ directory). Then, #include the
 * file and you're good to go:
 * 
 * #include "foo.h"
 * #include "../include/scrump.h" <--- Simply add this line to use.
 * #include "bar.h"
 * 
 * If you only want the declarations, and not the actual implementations, you can add 
 * #define SCRUMP_DECLARATIONS_ONLY right above the #include line, like so:
 * 
 * #include "foo.h"
 * #define SCRUMP_DECLARATIONS_ONLY <--- Turns off actual implementations.
...
// TODO: how can I put this below the API declarations?
typedef enum {
    SCRUMP_SUCCESS = 0,
...
#ifndef SCRUMP_DECLARATIONS_ONLY
...
#endif // SCRUMP_DECLARATIONS_ONLY
